...
hfh.for_his_metadata::json->>'ComunaId' as "COMUNA PARTICULAR TIT",----codigos validar tiene miles de numeros
(case when(length(hfh.for_his_metadata::json->>'CiudadId') <3 ) then concat('0',hfh.for_his_metadata::json->>'CiudadId')
else hfh.for_his_metadata::json->>'CiudadId'
end) as "CIUDAD PARTICULAR TIT",--antepuesto con 0
...
hfh.for_his_metadata::json->>'ProfesionId' as "PROFESION TIT",--codigo con 0 antepuestos no nombre
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
...
hfh.for_his_metadata::json->>'ProfesionId' as "PROFESION CONT",
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
...
hfh.for_his_metadata::json->>'ProfesionId' as "PROFESION PAG",
------Adicional
...
--and to_char(hfh.for_his_date_form::date,'yyyymmdd') between '20210901' and '20210931'
...
and hfh.for_his_metadata::json->>'Rut' like '13822991-2'
