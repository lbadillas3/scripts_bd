...
'' as "COMUNA_ASEGURADA",
'' as "CIUDAD_ASEGURADA",
hfh.for_his_metadata::json->>'ComunaId' as "C贸digo Ciudad asegurada",
hfh.for_his_metadata::json->>'ComunaId' as "C贸digo Comuna asegurada",
...
hbh.direccion_benef1 as "Direcci贸n Beneficiario _1",
...
hbh.direccion_benef2 as "Direcci贸n Beneficiario _2",
...
hbh.direccion_benef3 as "Direcci贸n Beneficiario _3",
...
hbh.direccion_benef4 as "Direcci贸n Beneficiario _4",
...
hbh.direccion_benef5 as "Direcci贸n Beneficiario _5",
...
hbh.direccion_benef6 as "Direcci贸n Beneficiario _6",
...
hbh.direccion_benef7 as "Direcci贸n Beneficiario _7",
...
--inner join cardif_hospitalario.cardif_hospitalario_comparativa chc on chc.rut = hfh.for_his_metadata::json->>'Rut'
left join (SELECT
...
--and ce2.est_id in (1,4,14) --ok
--and ce2.est_id in (2,5,8,12,13) --pendiente
--and ce2.est_id in (9,10,11,15) --rechazado
and ce.cal_eval_state is null
and to_char(hfh.for_his_date_form::date,'yyyymmdd') between '20211101' and 'yyyymmdd'
--and cc.con_id = '747335'
