...
isnull(hah.direccion_adi1,'') as "DIRECCION PARTICULAR AD1",
...
isnull(hah.direccion_adi2,'') as "DIRECCION PARTICULAR AD2",
...
isnull(hah.direccion_adi3,'') as "DIRECCION PARTICULAR AD3",
...
isnull(hah.direccion_adi4,'') as "DIRECCION PARTICULAR AD4",
...
isnull(hah.direccion_adi5,'') as "DIRECCION PARTICULAR AD5",
...
and to_date(fecha, 'YYYYMMDD') between '20220101' and '20220131'
