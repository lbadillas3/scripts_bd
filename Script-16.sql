...
to_char((hfh.for_his_metadata::json->>'Fechanacimiento')::date,'DD-MM-YYYY') as "FECHA DE NACIMIENTO",
...
hfh.for_his_metadata::json->>'Direccion' as "DIRECCION PARTICULAR",
hfh.for_his_metadata::json->>'ComunaId' as "COMUNA PARTICULAR",
hfh.for_his_metadata::json->>'ComunaId' as "CIUDAD PARTICULAR",
'' as "TELEFONOS",
hfh.for_his_metadata::json->>'Telefono' as "CELULAR",
hfh.for_his_metadata::json->>'Mail' as "EMAIL",
'' as "NO-EMAIL",
'' as "COD_TIPO",
'' as "COD_MARCA",
'' as "COD_MODELO",
...
'' as "PATENTE",
'' as "MOTOR",
hfh.for_his_metadata::json->>'Direccion' as "DIRECCION ASEGURADA",
'' as "COMUNA_ASEGURADA",
'' as "CIUDAD_ASEGURADA",
hfh.for_his_metadata::json->>'ComunaId' as "Código Ciudad asegurada",
hfh.for_his_metadata::json->>'ComunaId' as "Código Comuna asegurada",
...
'' as "DESC.PARENTESCO_1",
hbh.rut_benef1 as "RUT_BENEFICIARIO_1",
concat(hbh.nombre_benef1,' ',segundo_nombre_benef1)as "NOMBRES BENEFICIARIO_1",
...
hbh.direccion_benef1 as "Dirección Beneficiario _1",
hbh.comuna_benef1 as "Comuna Beneficiario_1",
hbh.ciudad_benef1 as "Cuidad Beneficiario_1",
-------------------
hbh.cod_benef2 as "COD.PARENTESCO_2",
'' as "DESC.PARENTESCO_2",
hbh.rut_benef2 as "RUT_BENEFICIARIO_2",
concat(hbh.nombre_benef2,' ',segundo_nombre_benef2)as "NOMBRES BENEFICIARIO_2",
...
hbh.direccion_benef2 as "Dirección Beneficiario _2",
hbh.comuna_benef2 as "Comuna Beneficiario_2",
hbh.ciudad_benef2 as "Cuidad Beneficiario_2",
------------------
hbh.cod_benef3 as "COD.PARENTESCO_3",
'' as "DESC.PARENTESCO_3",
hbh.rut_benef3 as "RUT_BENEFICIARIO_3",
concat(hbh.nombre_benef3,' ',segundo_nombre_benef3)as "NOMBRES BENEFICIARIO_3",
...
hbh.direccion_benef3 as "Dirección Beneficiario _3",
hbh.comuna_benef3 as "Comuna Beneficiario_3",
hbh.ciudad_benef3 as "Cuidad Beneficiario_3",
-------------------
hbh.cod_benef4 as "COD.PARENTESCO_4",
'' as "DESC.PARENTESCO_4",
hbh.rut_benef4 as "RUT_BENEFICIARIO_4",
concat(hbh.nombre_benef4,' ',segundo_nombre_benef4)as "NOMBRES BENEFICIARIO_4",
...
hbh.direccion_benef4 as "Dirección Beneficiario _4",
hbh.comuna_benef4 as "Comuna Beneficiario_4",
hbh.ciudad_benef4 as "Cuidad Beneficiario_4",
-------------------
hbh.cod_benef5 as "COD.PARENTESCO_5",
'' as "DESC.PARENTESCO_5",
hbh.rut_benef5 as "RUT_BENEFICIARIO_5",
concat(hbh.nombre_benef5,' ',segundo_nombre_benef5)as "NOMBRES BENEFICIARIO_5",
...
hbh.direccion_benef5 as "Dirección Beneficiario _5",
hbh.comuna_benef5 as "Comuna Beneficiario_5",
hbh.ciudad_benef5 as "Cuidad Beneficiario_5",
-------------------
hbh.cod_benef6 as "COD.PARENTESCO_6",
'' as "DESC.PARENTESCO_6",
hbh.rut_benef6 as "RUT_BENEFICIARIO_6",
concat(hbh.nombre_benef6,' ',segundo_nombre_benef6)as "NOMBRES BENEFICIARIO_6",
...
hbh.direccion_benef6 as "Dirección Beneficiario _6",
hbh.comuna_benef6 as "Comuna Beneficiario_6",
hbh.ciudad_benef6 as "Cuidad Beneficiario_6",
-------------------
hbh.cod_benef7 as "COD.PARENTESCO_7",
'' as "DESC.PARENTESCO_7",
hbh.rut_benef7 as "RUT_BENEFICIARIO_7",
concat(hbh.nombre_benef7,' ',segundo_nombre_benef7)as "NOMBRES BENEFICIARIO_7",
...
hbh.direccion_benef7 as "Dirección Beneficiario _7",
hbh.comuna_benef7 as "Comuna Beneficiario_7",
hbh.ciudad_benef7 as "Cuidad Beneficiario_7",
------Adicional
hah.cod_adi1  as "COD.PARENTESCO_1",
''  as "DESC.PARENTESCO_1",
hah.rut_adi1  as "RUT_ADICIONAL_1",
concat(hah.nombre_adi1,' ',segundo_nombre_adi1) as "NOMBRES ADICIONAL_1",
...
''  as "DESC.PARENTESCO_2",
hah.rut_adi2  as "RUT_ADICIONAL_2",
concat(hah.nombre_adi2,' ',segundo_nombre_adi2) as "NOMBRES ADICIONAL_2",
...
''  as "DESC.PARENTESCO_3",
hah.rut_adi3  as "RUT_ADICIONAL_3",
concat(hah.nombre_adi3,' ',segundo_nombre_adi3) as "NOMBRES ADICIONAL_3",
...
''  as "DESC.PARENTESCO_4",
hah.rut_adi4  as "RUT_ADICIONAL_4",
concat(hah.nombre_adi4,' ',segundo_nombre_adi4) as "NOMBRES ADICIONAL_4",
...
''  as "DESC.PARENTESCO_5",
hah.rut_adi5  as "RUT_ADICIONAL_5",
concat(hah.nombre_adi5,' ',segundo_nombre_adi5) as "NOMBRES ADICIONAL_5",
...
''  as "DESC.PARENTESCO_6",
hah.rut_adi6  as "RUT_ADICIONAL_6",
concat(hah.nombre_adi6,' ',segundo_nombre_adi6) as "NOMBRES ADICIONAL_6",
...
''  as "DESC.PARENTESCO_7",
hah.rut_adi7  as "RUT_ADICIONAL_7",
concat(hah.nombre_adi7,' ',segundo_nombre_adi7) as "NOMBRES ADICIONAL_7",
...
--and hfh.for_his_date_form between '20211001' and '20210931'
and hfh.for_his_date_form between to_char(now (),'YYYYMM01')::date and to_char(now () - INTERVAL '1 DAY','YYYYMMDD')::date
