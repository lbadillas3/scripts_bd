...
where
	...
	and hfh.for_his_metadata::json->>'pro_cod_plan' = 'INCED4' and las.con_id is null and hfh.for_his_metadata::json->>'id_campana' in ('265a9d74-69d5-4d58-8996-ad019d2e1fad','98995a51-9e56-444a-a16d-d3cea1dc6683')
