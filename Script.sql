...
hfh.for_his_metadata::json->>'Rut' as "RUT CLIENTE",
UPPER(hfh.for_his_metadata::json->>'Nombre') as "PRIMER NOMBRE",
UPPER(hfh.for_his_metadata::json->>'SegundoNombre') as "SEGUNDO NOMBRE",
concat(UPPER(hfh.for_his_metadata::json->>'ApPaterno'),' ', UPPER(hfh.for_his_metadata::json->>'ApMaterno'))  as "APELLIDOS",
...
where
	...
	--and hfh.for_his_date_form::date <= '20210706'
	and hgh.ges_his_tipificacion_4 in ('Acepta Contratar') and length(for_his_genesys_id) > 30
	...
	and hfh.for_his_metadata::json->>'pro_cod_plan' = 'INCED4'