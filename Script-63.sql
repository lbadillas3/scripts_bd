...
hfh.for_his_con_id as "INDICE TMK",
...
and ce2.est_id in (11,1,4,14)
and ce.cal_eval_state is null
and hfh.for_his_metadata::json->>'Rut' in ('2385614-0', '1676452-0')
--and to_char(hfh.for_his_date_form::date,'yyyymmdd') between '20211201' and '20211231'
