...
cc.con_metadata::json->>'sexo' as "GENERO TIT",
...
hfh.for_his_metadata::json->>'Comuna' as "COMUNA PARTICULAR TIT",
hfh.for_his_metadata::json->>'Ciudad' as "CIUDAD PARTICULAR TIT",
hfh.for_his_metadata::json->>'Nacionalidad' as "PAIS RESIDENCIA",
...
cc.con_metadata::json->>'sexo' as "GENERO CONT",
...
hfh.for_his_metadata::json->>'Comuna' as "COMUNA PARTICULAR CONT",
hfh.for_his_metadata::json->>'Ciudad' as "CIUDAD PARTICULAR CONT",
...
cc.con_metadata::json->>'sexo' as "GENERO PAG",
...
hfh.for_his_metadata::json->>'Comuna' as "COMUNA PARTICULAR PAG",
hfh.for_his_metadata::json->>'Ciudad' as "CIUDAD PARTICULAR PAG",
...
concat(cc.con_metadata::json->>'rut','-',cc.con_metadata::json->>'dv') as "RUT Vendedor",
---FIN REVISAR
------Adicional
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 ...
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD1",
...
hah.telefono_adi1  as "TELEFONO PARTICULAR AD1",
'' as "MOVIL PARTICULAR AD1",
hah.mail_adi1  as "Mail AD1",
...
hah.cod_adi1  as "PARENTESCO AD1",
'0' as "PRIMA AD1",
hah.porcentaje_adi1  as "% AD1",
-------------------
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD2",
...
hah.telefono_adi2  as "TELEFONO PARTICULAR AD2",
'' as "MOVIL PARTICULAR AD2",
hah.mail_adi2  as "Mail AD2",
...
hah.cod_adi2  as "PARENTESCO AD2",
'0' as "PRIMA AD2",
hah.porcentaje_adi2  as "% AD2",
------------------
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD3",
...
hah.telefono_adi3  as "TELEFONO PARTICULAR AD3",
'' as "MOVIL PARTICULAR AD3",
hah.mail_adi3  as "Mail AD3",
...
hah.cod_adi3  as "PARENTESCO AD3",
'0' as "PRIMA AD3",
hah.porcentaje_adi3  as "% AD3",
-------------------
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD4",
...
hah.telefono_adi4  as "TELEFONO PARTICULAR AD4",
'' as "MOVIL PARTICULAR AD4",
hah.mail_adi4  as "Mail AD4",
...
hah.cod_adi4  as "PARENTESCO AD4",
'0' as "PRIMA AD4",
hah.porcentaje_adi4  as "% AD4",
-------------------
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD5",
...
hah.telefono_adi5  as "TELEFONO PARTICULAR AD5",
'' as "MOVIL PARTICULAR AD5",
hah.mail_adi5  as "Mail AD5",
...
hah.cod_adi5  as "PARENTESCO AD5",
'0' as "PRIMA AD5",
hah.porcentaje_adi5  as "% AD5",
-------------------
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD6",
concat(hah.nombre_adi6,' ',segundo_nombre_adi6) as "NOMBRES AD6",
hah.paterno_adi6  as "APELLIDO PATERNO AD6",
hah.materno_adi6  as "APELLIDO MATERNO AD6",
split_part(hah.rut_adi6, '-',  1) as "RUT AD6",
split_part(hah.rut_adi6, '-',  2) as "DIGITO VERIFICADOR AD6",
hah.telefono_adi6  as "TELEFONO PARTICULAR AD6",
'' as "MOVIL PARTICULAR AD6",
hah.mail_adi6  as "Mail AD6",
hah.fecha_nacimiento_adi6 as "FEC_NACIMIENTO AD6",
hah.direccion_adi6  as "DIRECCION PARTICULAR AD6",
hah.comuna_adi6  as "COMUNA PARTICULAR AD6",
hah.ciudad_adi6  as "CIUDAD PARTICULAR AD6",
hah.cod_adi6  as "PARENTESCO AD6",
'0' as "PRIMA AD6",
hah.porcentaje_adi6  as "% AD6",
-------------------
(case 
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='31' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='32' then '03'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='41' then '04'
 when replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','')='42' then '04'
 else '0'||replace(hfh.for_his_metadata::json->>'pro_cod_plan_sponsor','0','') end) as "PLAN AD7",
concat(hah.nombre_adi7,' ',segundo_nombre_adi7) as "NOMBRES AD7",
hah.paterno_adi7  as "APELLIDO PATERNO AD7",
hah.materno_adi7  as "APELLIDO MATERNO AD7",
split_part(hah.rut_adi7, '-',  1) as "RUT AD7",
split_part(hah.rut_adi7, '-',  2) as "DIGITO VERIFICADOR AD7",
hah.telefono_adi7  as "TELEFONO PARTICULAR AD7",
'' as "MOVIL PARTICULAR AD7",
hah.mail_adi7  as "Mail AD7",
hah.fecha_nacimiento_adi7 as "FEC_NACIMIENTO AD7",
hah.direccion_adi7  as "DIRECCION PARTICULAR AD7",
hah.comuna_adi7  as "COMUNA PARTICULAR AD7",
hah.ciudad_adi7  as "CIUDAD PARTICULAR AD7",
hah.cod_adi7  as "PARENTESCO AD7",
'0' as "PRIMA AD7",
hah.porcentaje_adi7  as "% AD7",
------beneficiario
...
hbh.cod_benef1 as "PARENTESCO B1",
...
hbh.telefono_benef1 as "TELEFONO PARTICULAR B1",
'' as "MOVIL PARTICULAR B1",
hbh.mail_benef1 as "CORREO PARTICULAR B1",
-------------------
...
hbh.cod_benef2 as "PARENTESCO B2",
...
hbh.telefono_benef2 as "TELEFONO PARTICULAR B2",
'' as "MOVIL PARTICULAR B2",
hbh.mail_benef2 as "CORREO PARTICULAR B2",
------------------ 
...
hbh.cod_benef3 as "PARENTESCO B3",
...
hbh.telefono_benef3 as "TELEFONO PARTICULAR B3",
'' as "MOVIL PARTICULAR B3",
hbh.mail_benef3 as "CORREO PARTICULAR B3",
-------------------
...
hbh.cod_benef4 as "PARENTESCO B4",
...
hbh.telefono_benef4 as "TELEFONO PARTICULAR B4",
'' as "MOVIL PARTICULAR B4",
hbh.mail_benef4 as "CORREO PARTICULAR B4",
-------------------
...
hbh.cod_benef5 as "PARENTESCO B5",
...
hbh.telefono_benef5 as "TELEFONO PARTICULAR B5",
'' as "MOVIL PARTICULAR B5",
hbh.mail_benef5 as "CORREO PARTICULAR B5",
-------------------
...
hbh.cod_benef6 as "PARENTESCO B6",
...
hbh.telefono_benef6 as "TELEFONO PARTICULAR B6",
'' as "MOVIL PARTICULAR B6",
hbh.mail_benef6 as "CORREO PARTICULAR B6",
-------------------
...
hbh.cod_benef7 as "PARENTESCO B7",
...
hbh.telefono_benef7 as "TELEFONO PARTICULAR B7",
'' as "MOVIL PARTICULAR B7",
hbh.mail_benef7 as "CORREO PARTICULAR B7",
'REC' as "ESTADO PROPUESTA"
-------
...
when hbh.ben_his_metadata::json->>''Parentesco'' is null then '' ''
	else SPLIT_PART(hbh.ben_his_metadata::json->>''Parentesco'', ''-'', 2)
end
...
comuna_benef7 TEXT,
ciudad_benef7 text,
fecha_nacimiento_benef7 text)) hbh on hbh.ben_his_con_id = hfh.for_his_con_id::numeric
left join (SELECT
...
--and hfh.for_his_date_form between '20211101' and '20211130'
and hfh.for_his_date_form between to_char(now (),'YYYY-MM-01')::date and to_char(now () - INTERVAL '1 DAY','YYYY-MM-DD')::date
--and split_part(hfh.for_his_metadata::json->>'Rut', '-',  1) in ('11291067','11652642','11674863','11984598','12029622','12915626','12946977','13510720','13889139','14054697','14285590','14302001','15485415','15498448','15868451','15943034','16197773','16299263')
and for_his_metadata::json->>'id_campana' in ('506d64a7-9e0f-4d01-bff0-eb3505d67275','cc4fc4a7-60a6-4860-a6bf-cc4baef8f056')