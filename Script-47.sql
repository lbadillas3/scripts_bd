...
(case when (trim(hah.telefono_adi1 ) <> '' or not null) then hah.telefono_adi1 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR AD1",
'' as "MOVIL PARTICULAR AD1",
(case when (trim(hah.mail_adi1 ) <> '' or not null) then hah.mail_adi1 else hfh.for_his_metadata::json->>'Mail' end) as "Mail AD1",
...
(case when (trim(hah.telefono_adi2 ) <> '' or not null) then hah.telefono_adi2 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR AD2",
'' as "MOVIL PARTICULAR AD2",
(case when (trim(hah.mail_adi2 ) <> '' or not null) then hah.mail_adi2 else hfh.for_his_metadata::json->>'Mail' end) as "Mail AD2",
...
(case when (trim(hah.telefono_adi3 ) <> '' or not null) then hah.telefono_adi3 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR AD3",
'' as "MOVIL PARTICULAR AD3",
(case when (trim(hah.mail_adi3 ) <> '' or not null) then hah.mail_adi3 else hfh.for_his_metadata::json->>'Mail' end) as "Mail AD3",
...
(case when (trim(hah.telefono_adi4 ) <> '' or not null) then hah.telefono_adi4 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR AD4",
'' as "MOVIL PARTICULAR AD4",
(case when (trim(hah.mail_adi4 ) <> '' or not null) then hah.mail_adi4 else hfh.for_his_metadata::json->>'Mail' end) as "Mail AD4",
...
(case when (trim(hah.telefono_adi5 ) <> '' or not null) then hah.telefono_adi5 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR AD5",
'' as "MOVIL PARTICULAR AD5",
(case when (trim(hah.mail_adi5 ) <> '' or not null) then hah.mail_adi5 else hfh.for_his_metadata::json->>'Mail' end) as "Mail AD5",
...
(case when (trim(hbh.telefono_benef1) <> '' or not null) then hbh.telefono_benef1 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR B1",
hbh.telefono_benef1,
'' as "MOVIL PARTICULAR B1",
(case when (trim(hbh.mail_benef1) <> '' or not null) then hbh.mail_benef1 else hfh.for_his_metadata::json->>'Mail' end) as "CORREO PARTICULAR B1",
-------------------
...
(case when (trim(hbh.telefono_benef2) <> '' or not null) then hbh.telefono_benef2 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR B2",
'' as "MOVIL PARTICULAR B2",
(case when (trim(hbh.mail_benef2) <> '' or null) then hbh.mail_benef2 else hfh.for_his_metadata::json->>'Mail' end) as "CORREO PARTICULAR B2",
------------------ 
...
(case when (trim(hbh.telefono_benef3) <> '' or not null) then hbh.telefono_benef3 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR B3",
'' as "MOVIL PARTICULAR B3",
(case when (trim(hbh.mail_benef3) <> '' or not null) then hbh.mail_benef3 else hfh.for_his_metadata::json->>'Mail' end) as "CORREO PARTICULAR B3",
-------------------
...
(case when (trim(hbh.telefono_benef4) <> '' or not null) then hbh.telefono_benef4 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR B4",
'' as "MOVIL PARTICULAR B4",
(case when (trim(hbh.mail_benef4) <> '' or not null) then hbh.mail_benef4 else hfh.for_his_metadata::json->>'Mail' end) as "CORREO PARTICULAR B4",
-------------------
...
(case when (trim(hbh.telefono_benef5) <> '' or not null) then hbh.telefono_benef5 else hfh.for_his_metadata::json->>'Telefono' end) as "TELEFONO PARTICULAR B5",
'' as "MOVIL PARTICULAR B5",
(case when (trim(hbh.mail_benef5) <> '' or not null) then hbh.mail_benef5 else hfh.for_his_metadata::json->>'Mail' end) as "CORREO PARTICULAR B5",
...
when hah.adi_his_metadata::json->>''cod_nacionalidad_campana'' is null then ''''
	 else hah.adi_his_metadata::json->>''cod_nacionalidad_campana''
end
FROM "Genesys".his_aditional_history hah inner join (SELECT min(hah.adi_his_id) as mini,hah.adi_his_con_id
from "Genesys".his_aditional_history hah
where hah.adi_his_con_id <> ''{{dialer.con_id}}''
